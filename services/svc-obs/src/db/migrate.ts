...
const migrations = [
  ...
  {
    version: "005_outbox_deliveries",
    file: "005_outbox_deliveries.sql",
    downFile: "005_outbox_deliveries_down.sql",
  },
];

const migrator = createMigrator({ migrations, migrationsDir, lockKey: 1004 });
